...
export default async function CharacterInfo({ mal_id }: { mal_id: number }) {
	...
	return (
		<div className="bg-slate-400/60 max-h-[80vh] overflow-scroll rounded-xl p-4 flex flex-col items-center space-y-4 shadow-2xl shadow-slate-500 backdrop-blur-sm">
			<Image
